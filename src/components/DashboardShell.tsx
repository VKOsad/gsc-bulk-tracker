...
import { Settings, LogOut, Sparkles, Globe, Newspaper, LayoutDashboard, TrendingUp, Anchor, BarChart2, Target } from "lucide-react";
...
function NavLinks() {
  ...
  const items = [
    ...
    { href: "/rank-tracker", label: t("navTopvisor"), key: "rank-tracker", icon: <Target size={14} /> },
