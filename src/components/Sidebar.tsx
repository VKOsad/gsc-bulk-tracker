...
import { LayoutDashboard, Globe, Settings, TrendingUp, Anchor, BarChart2, LogOut, ChevronDown, Target } from "lucide-react";
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { href: "/rank-tracker", icon: <Target size={18} />, label: t("navTopvisor") },
  ];
